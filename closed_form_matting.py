...
def main():
    ...
    # arg_parser.image = ''
    # arg_parser.trimap= ''
    # arg_parser.scribbles = ''
    # arg_parser.output = ''
    #
    # args = arg_parser.parse_args()

    image = './close_form_matting/testSource.jpg'
    scribbles = './close_form_matting/testScribble.jpg'
    trimap=''
    solve_fg= ''
    output_alpha= './close_form_matting/final.png'

    image = cv2.imread(image, cv2.IMREAD_COLOR) / 255.0

    if scribbles:
        scribbles = cv2.imread(scribbles, cv2.IMREAD_COLOR) / 255.0
    ...
    cv2.imwrite(output_alpha, output * 255.0)
